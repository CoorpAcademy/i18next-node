(function() {
    ...
    i18n.dynamicResourcesMiddlewareWrapper = function(options) {
        options = options || {};
        var maxAge = options.maxAge ? options.maxAge : 60 * 60 * 24 * 30;
    ...
    i18n.serveDynamicResources = function(app, options) {
        app.get('/locales/resources.json', dynamicResourcesMiddlewareWrapper(options));
        return i18n;
    };

    i18n.missingKeyRouteWrapper = function(authenticated) {
        return function(req, res) {
    ...
    i18n.serveMissingKeyRoute = function(app, authenticated) {
        app.post('/locales/add/:lng/:ns', missingKeyRouteWrapper(authenticated));
        return i18n;
    };
